  ...
  return (
    <section className="m-auto mb-2 mt-8 max-w-4xl">
      ...
      <p>
        ...
        interest involves earning, or owing, interest on your interest. – <a href="https://www.investopedia.com/terms/c/compoundinterest.asp">Investopedia.com</a>
      </p>

      <h2 className="my-6 font-bold">Formula for compound interest</h2>
      <p>Compound interest = total amount of principal and interest in future (or future value) minus principal amount at present (or present value)</p>
      ...
      <p className="mb-28">
        Numbers entered into the calculator are saved via <a href="https://developer.mozilla.org/en-US/docs/Web/API/Window/localStorage">local storage</a> so users can come back to the same page and
